...
<h1>Product Categories Control Panel <small> Add / Edit / Delete your Categories items</small></h1>
	<a class="btn btn-blue" href="<?php echo $this->Html->url(array('controller'=>'bcategories','action'=>'add')) ?>">
	+ Add new category</a>
</div>
									...
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										<thead>
											<tr>
												...
												<th class="center">Product Categories</th>
										...
										$editurl = $this->html->url(array('controller' => 'bcategories' , 'action'=>'edit', $key));
										$upurl = $this->html->url(array('controller' => 'bcategories' , 'action'=>'moveup', $key));
										$downurl = $this->html->url(array('controller' => 'bcategories' , 'action'=>'movedown', $key));
										$deleteurl = $this->html->url(array('controller' => 'bcategories' , 'action'=>'delete', $key));
      
 			  
										echo "<tr>";
										echo "<td>".$mydata[$i]['Bcategory']['id']."</td>";
										echo "<td >".$value."</td>";
										
										
										echo "<td>".$mydata[$i]['Bcategory']['description']."</td>";
										$i++;
