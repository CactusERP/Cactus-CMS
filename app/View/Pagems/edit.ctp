<!-- File: /app/View/Posts/add.ctp -->
	...
	<?php	
			...
			echo "<div class='form-group'>";
			echo "<div class='col-sm-9'>";
				echo $this->Form->input('header' , array('type' => 'textarea' , 'class' => 'mytextareasizesmall'));
			echo "</div>";
			echo "</div>";	
				
			echo "<div class='form-group'>";
			echo "<div class='col-sm-9'>";
				echo $this->Form->input('body' , array( 'type' => 'textarea' , 'class' => 'mytextareasize' , 'value' => $mybody));
			echo "</div>";
			echo "</div>";
