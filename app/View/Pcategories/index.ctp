...
<h1>Product Categories Control Panel <small> Add / Edit / Delete your Categories items</small></h1>
	<a class="btn btn-blue" href="<?php echo $this->Html->url(array('controller'=>'pcategories','action'=>'add')) ?>">
	+ Add new category</a>
</div>
				...
				<a class="btn btn-xs btn-link panel-config" href="#panel-config" data-toggle="modal">
								...
								<div class="panel-body">
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										...
										$editurl = $this->html->url(array('controller' => 'pcategories' , 'action'=>'edit', $key));
										$upurl = $this->html->url(array('controller' => 'pcategories' , 'action'=>'moveup', $key));
										$downurl = $this->html->url(array('controller' => 'pcategories' , 'action'=>'movedown', $key));
										$deleteurl = $this->html->url(array('controller' => 'pcategories' , 'action'=>'delete', $key));
      
 			  
										echo "<tr>";
										echo "<td>".$mydata[$i]['Pcategory']['id']."</td>";
										echo "<td >".$value."</td>";
										
										
										echo "<td>".$mydata[$i]['Pcategory']['description']."</td>";
										$i++;
