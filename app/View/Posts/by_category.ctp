		...
		<div class="panel-tools">
								...
								<div class="panel-body">
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										...
										$editurl = $this->html->link("Edit", array('action'=>'edit', $post['Post']['ID']), array('style'=>'color:#E6B800'));
										$deleteurl = $this->html->link("Delete", array('action'=>'delete', $post['Post']['ID']) , array('style'=>'color:#c43c35'));
										?>
											<tr>
