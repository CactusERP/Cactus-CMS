...
<?php
		...
		echo $this->Form->create('Product', array('type' => 'file',  'role' => 'form' , 'class' => 'form-horizontal' ));
		...
		echo $this->Form->input('price' , array('placeholder' => 'Price' , 'id' => 'form-field-1' , 'class' => 'form-control'));
		echo $this->Form->input('vat' , array('placeholder' => 'Vat' , 'id' => 'form-field-1' , 'class' => 'form-control'));
